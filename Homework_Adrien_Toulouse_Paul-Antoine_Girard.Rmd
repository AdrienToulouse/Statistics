...
Then, we can conclude that our estimator $\hat\theta_{MLE}$ is efficient.
...
and applying the law of large numbers gives us: $$(\theta - \overline{X_n})\overset{p} {\to} 0$$
...
We want to prove that $\hat\theta_{2} \overset{p} {\to} \theta$.
