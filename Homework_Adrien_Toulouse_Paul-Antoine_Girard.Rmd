...
In order to apply some statistic methods, we will construct a confidence interval for the mean of the RTEN variable. In fact, we assumed during this report that this variable follows a gaussian distribution. So, it will be interesting to estimate its mean without knowing its variance.  
